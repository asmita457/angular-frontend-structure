...
export class CustomerCreateComponent implements OnInit, CreateUpdateComponentInterface {
  ...
  isCreate = 1;
  titleMessage = "Create new Customer";
  ...
  ngOnInit() {
    ...
    if (this.id) {
      ...
      this.isCreate = 0;
      this.titleMessage = "Update Customer";
