...
export class CustomerListComponent implements OnInit, ListComponentInterface {
  ...
  handleViewData(data) {
    this.router.navigate(['admin/customers/' + data.id + '/view']);
  }

  handleUpdateData(data) {
    this.router.navigate(['admin/customers/' + data.id + '/update']);
  }

  handlePassbookData(data) {
    this.router.navigate(['admin/customers/' + data.id + '/passbook'])
  }
